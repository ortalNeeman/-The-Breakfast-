...
lib.ssMetadata = [
		{name:"OrtalNeeman_atlas_1", frames: [[2031,429,12,12],[2011,441,12,12],[1607,592,86,76],[1926,402,83,102],[1819,520,148,118],[1926,283,73,117],[2025,443,12,12],[2011,455,12,12],[2025,457,12,12],[2011,469,12,12],[2011,415,13,12],[2025,471,12,12],[2011,483,12,12],[2025,485,12,12],[2028,499,12,12],[1926,506,12,12],[1940,506,12,12],[1954,506,12,12],[2028,513,12,12],[2028,527,12,12],[2028,541,12,12],[2029,555,12,12],[2029,569,12,12],[1110,0,626,325],[1470,592,135,126],[1695,641,59,46],[1969,556,58,47],[1819,283,105,235],[1738,0,306,281],[1695,592,58,47],[1755,592,58,47],[1090,1218,340,263],[1834,740,57,47],[1470,327,347,263],[1090,953,347,263],[1644,741,57,47],[1703,745,57,47],[1982,702,56,48],[1470,720,56,48],[1900,957,55,48],[1811,689,55,49],[1828,906,54,49],[1884,906,54,49],[1940,906,54,49],[1957,957,55,48],[1607,670,54,50],[1893,802,53,50],[1827,838,53,50],[1756,641,53,51],[1969,605,58,47],[1528,720,56,48],[1982,752,57,47],[1868,689,55,49],[1773,790,52,51],[1788,957,54,49],[1882,854,53,50],[1937,854,53,50],[1992,854,53,50],[1844,957,54,49],[1719,694,55,49],[1586,722,56,48],[1893,753,57,47],[1969,506,57,48],[1439,953,347,263],[1815,640,58,47],[1875,640,58,47],[1935,654,59,46],[1776,740,56,48],[1925,702,55,49],[1663,689,54,50],[1834,789,57,47],[1900,1007,55,48],[1952,801,52,51],[1773,890,53,50],[2039,459,6,4],[2046,0,2,14],[2041,388,7,8],[2011,397,17,16],[1813,283,4,40],[2036,373,3,6],[2030,397,9,30],[2042,358,6,8],[2020,373,14,4],[2041,373,7,13],[2001,384,37,11],[2041,398,4,14],[2011,429,18,10],[2029,583,10,14],[2042,343,6,13],[2029,599,10,12],[1996,654,50,23],[2020,343,20,28],[1786,283,25,42],[2034,283,14,58],[1110,327,358,468],[2039,443,6,6],[2039,451,6,6],[1738,283,46,40],[2001,283,31,56],[2001,341,17,41],[1110,797,661,154],[0,0,1108,819],[0,821,1088,546]]}
];
...
(lib.star = function(mode,startPosition,loop) {
	...
	this.instance_2 = new lib.CachedBmp_1072();
	...
	this.instance_8 = new lib.CachedBmp_1066();
	...
	this.instance_34 = new lib.CachedBmp_1040();
	this.instance_34.setTransform(27.25,31.85,0.5,0.5);

	this.instance_35 = new lib.CachedBmp_1040();
	this.instance_35.setTransform(27.25,31.85,0.5,0.5);

	this.instance_36 = new lib.CachedBmp_1072();
	this.instance_36.setTransform(26.55,31,0.5,0.5);

	this.instance_37 = new lib.CachedBmp_1036();
	this.instance_37.setTransform(28.9,32.15,0.5,0.5);

	this.instance_38 = new lib.CachedBmp_1035();
...
(lib.playy = function(mode,startPosition,loop) {
	...
	this.instance = new lib.CachedBmp_1033();
	this.instance.setTransform(0,0,0.5,0.5);
...
(lib.Scene_1_weal = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-187.95,111.15,1,1,4.9642,0,0,148.2,81.3);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(178).to({_off:false},0).wait(1).to({regX:143.2,regY:81.2,rotation:6.2838,x:-157.6,y:111.65},0).wait(1).to({rotation:7.6029,x:-122.25,y:112.8},0).wait(1).to({rotation:8.922,x:-86.95,y:113.85},0).wait(1).to({rotation:10.2411,x:-51.65,y:114.95},0).wait(1).to({rotation:11.5602,x:-16.3,y:116.05},0).wait(1).to({rotation:12.8793,x:19,y:117.1},0).wait(1).to({rotation:14.1984,x:54.4,y:118.2},0).wait(1).to({rotation:15.5175,x:89.7,y:119.3},0).wait(1).to({rotation:16.8366,x:124.95,y:120.4},0).wait(1).to({rotation:18.1557,x:160.3,y:121.5},0).wait(1).to({regX:148.8,regY:80,x:165,y:123.05},0).wait(1).to({regX:143.2,regY:81.2,x:159.25,y:122.4},0).wait(314).to({_off:true},1).wait(49));
...
(lib.fish_shoke = function(mode,startPosition,loop) {
	...
	// fish_hand
	this.instance_1 = new lib.CachedBmp_973();
	this.instance_1.setTransform(67,118.3,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_921();
	...
	this.instance_17 = new lib.CachedBmp_910();
	...
	// fish_body
	this.instance_40 = new lib.CachedBmp_1031();
	this.instance_40.setTransform(0,0,0.5,0.5);

	this.instance_41 = new lib.CachedBmp_1024();
	this.instance_41.setTransform(3.35,0,0.5,0.5);
	this.instance_41._off = true;

	this.instance_42 = new lib.CachedBmp_1029();
...
(lib.fish = function(mode,startPosition,loop) {
	...
	this.instance_3 = new lib.CachedBmp_882();
	...
	this.instance_7 = new lib.CachedBmp_880();
	...
	this.instance_9 = new lib.CachedBmp_947();
	...
	this.instance_11 = new lib.CachedBmp_910();
	this.instance_11.setTransform(65.25,120,0.5,0.5);

	this.instance_12 = new lib.CachedBmp_909();
	this.instance_12.setTransform(65.5,119.75,0.5,0.5);

	this.instance_13 = new lib.CachedBmp_908();
	...
	this.instance_16 = new lib.CachedBmp_905();
	this.instance_16.setTransform(66.5,118.8,0.5,0.5);

	this.instance_17 = new lib.CachedBmp_921();
	...
	// fish_body
	this.instance_18 = new lib.CachedBmp_684();
...
(lib.Scene_1_background_eating = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.instance_34},{t:this.instance_33},{t:this.instance_32}]},504).wait(87));
...
(lib.OrtalNeeman = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.weal).wait(179).to({regX:-10.4,regY:122,x:-10.4,y:122},0).wait(10).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-10.4,regY:122,x:-10.4,y:122},0).wait(315).to({regX:0,regY:0,x:0,y:0},0).to({_off:true},49).wait(84));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OrtalNeeman_atlas_1.png?1588688325907", id:"OrtalNeeman_atlas_1"},
		{src:"sounds/breakfast.mp3?1588688326186", id:"breakfast"},
		{src:"sounds/eatt.mp3?1588688326186", id:"eatt"},
		{src:"sounds/end.mp3?1588688326186", id:"end"},
		{src:"sounds/Howw.mp3?1588688326186", id:"Howw"},
		{src:"sounds/please.mp3?1588688326186", id:"please"},
		{src:"sounds/glanbubbles.mp3?1588688326186", id:"glanbubbles"}
	],
	preloads: []
};
